...
to 0 (as the last element). Example: countdown(5) should return [5,4,3,2,1,0]
"""
def countdown(n):
    result = []
...
Print the first value and return the second. Example: print_and_return([1,2]) should print 1 and return 2
"""
...
of the first value in the list plus the list's length. Example:
...
"""
def length_and_value(length, number):
    result = []
